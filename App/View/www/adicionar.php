<div class="container">
    <h2 class="text-center my-3">Adicionar material</h2>
        ...
        <?php foreach ($this->selectMateriaisJoin() as $key => $value) { ?>
            <div class="card m-2" style="max-width: 300px;">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo url; ?>adicionar/<?php echo $value['id']; ?>" class="btn btn-warning"><strong><i class="fa fa-sign-in" aria-hidden="true"></i> Adicionar</strong></a>
                </div>
            </div>
        <?php } ?>
    </div>
