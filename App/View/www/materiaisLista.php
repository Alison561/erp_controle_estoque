<div class="container">
    <h2 class="text-center my-3">Lista de materias cadastros</h2>
        ...
        <?php foreach ($this->selectMateriaisJoin() as $key => $value) { ?>
            <div class="card m-2" style="max-width: 300px;">
                ...
                <div class="card-body">
                    ...
                    <!-- <a href="<?php echo url; ?>materiais/editar/<?php echo $value['id']; ?>" class="btn btn-warning"><strong><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</strong></a> -->
                </div>
            </div>
        <?php } ?>
    </div>
